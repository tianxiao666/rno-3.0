...
<script src="js/rno_lte_pci_interanalysis.js"></script>
<script src="js/trafficstaticsView.js"></script>
<script src="jslib/farbtastic/farbtastic.js"></script>
<script src="js/cityMapGrid.js"></script>
<script src="jslib/lib_mapgrid.js"></script>
<style type="text/css">
html,body {
	width: 100%;
	height: 100%;
								  ...
								  <tr>
									<td valign="top">
									    <table width="100%" align="right" cellpadding="0" cellspacing="0" style="border:1px solid #ccc; font-size:12px">
											<caption align="top" style="border:1px solid #ccc;font-weight: bold;">颜色设置</caption>
											  <tr>
											    <th width="37%" style="border:1px solid #ccc;"></th>
											    <th width="40%" style="border:1px solid #ccc;">颜色</th>
											  </tr>
											  <tr>
											    <td align="center" style="border:1px solid #ccc;">小区自身</td>
											  ...
											  <tr>
											    <td align="center" style="border:1px solid #ccc;">重叠小区</td>
											    <td style="border:1px solid #ccc;background-color:#FF00FF"></td>
											  </tr>
											  <tr>
											    <td align="center" style="border:1px solid #ccc;">PCI模3为0小区</td>
											    <td style="border:1px solid #ccc;background-color:#FF0033"></td>
											  </tr>
											  <tr>
											    <td align="center" style="border:1px solid #ccc;">PCI模3为1小区</td>
											    <td style="border:1px solid #ccc;background-color:#FFFF00"></td>
											  </tr>
											  <tr>
											    <td align="center" style="border:1px solid #ccc;">PCI模3为2小区</td>
											    <td style="border:1px solid #ccc;background-color:#0B4C5F"></td>
											  </tr>
									  	</table>
								    </td>
								    <td valign="top">
