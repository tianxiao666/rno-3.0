...
<script type="text/javascript" src="js/rno_res_lte_zte_ho.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > 中兴切换数据管理 </h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">中兴切换数据导入</a></li>
			<li><a href="#tabs-2">中兴切换数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_ZTE_HO_FILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_ZTE_HO_FILE" /> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">LTE中兴切换数据文件<span class="txt-impt">*</span>
											</td>
			...
			<form id="searchNcsForm">
				...
				<table>
					<tr>
						...
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="ncsMeaEndDate" name="attachParams['meaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchNcsBtn" value="查询"></input></td>
					</tr>
				</table>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				...
				<div class="paging_div" id="ncsListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryZteHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryZteHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryZteHoDescData,'searchNcsForm','ncsListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryZteHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryZteHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
