...
<script type="text/javascript" src="js/rno_new_cell_manage.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：新站优化 > 新站邻区规划</h2></span>
	...
	<div id="tabs">
			...
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<%--  input type="hidden" name="fileCode" id='fileCode'
								value="GSMNEWCELLFILE" /--%> <input type="hidden"
								...
								<tr>
									...
									<td><select id="dateType"
										name="" style="width:120px">
											<option value='GSMNEWCELLFILE'>GSM新站数据</option>
											<option value='LTENEWCELLFILE'>LTE新站数据</option>
									</select></td>
					...
					<div id="importDiv" class="importContent" style="height:250px">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<%-- input type="hidden" name="fileCode" id='fileCode'value="GSMNEWCELLFILE" /--%> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">文件(CSV)<span class="txt-impt">*</span>
											</td>
										...
										<tr>
											...
											<td style="width: 50%;" colspan="0">GSM新站数据   <input type="radio" id="cellData" class="fileType" name="fileCode" value="GSMNEWCELLFILE" checked="checked" />　LTE新站数据    <input type="radio" id="enginData" name="fileCode" value="LTENEWCELLFILE" /></td>
										</tr>
									</tbody>
		...
		<%-- <div id="tabs-2">
			<form id="searchNcsForm">
				...
				<table>
					<tr>
						<td style="display:none"><select id="provincemenu2">
								<s:iterator value="provinceAreas" id="onearea">
									<option value="<s:property value='#onearea.area_id' />">
										<s:property value="#onearea.name" />
									</option>
