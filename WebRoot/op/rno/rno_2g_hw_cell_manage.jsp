...
<script type="text/javascript" src="js/rno_2g_hw_cell_manage.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > 小区数据管理 > 华为2G小区数据管理</h2></span>
			...
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="2GHWCELLFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportCell" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'value="2GHWCELLFILE" /> <input type="hidden" name="token"
								id="token" value="" />
			...
			<form id="searchCellForm">
				...
				<table>
					<tr>
						...
						<td  style="padding-left:10px"><input type="button" id="searchCellBtn" value="查询导入记录"></input></td>
					</tr>
				</table>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				...
				<div class="paging_div" id="cellListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryCellDescData,'searchCellForm','cellListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryCellDescData,'searchCellForm','cellListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryCellDescData,'searchCellForm','cellListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryCellDescData,'searchCellForm','cellListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryCellDescData,'searchCellForm','cellListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
