...
<html>
  ...
  <body>
	...
	<font style="font-weight: bold;">当前位置： 动态覆盖 > LTE天线方位角评估</font>
	<br>
	<div id="structureTaskDiv">
			...
			<div style="width: 80%;margin-left: 6%;padding-top: 10px">
				<table width="50%">
					<tbody>
						<tr>
							<td style="width: 5%">
								<p><font style="font-weight: bold">方位角评估分析任务列表</font></p>
							</td>
							<td style="width: 15%">
			...
			<div style="width: 80%;margin-left: 6%;padding-top: 10px">
				...
				<form id='downloadStructureFileForm' action='downloadLteAzimuthAssessFileAction' method='post' style="display:none">
