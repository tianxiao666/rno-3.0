...
<script type="text/javascript"
	src="js/rno_structure_ncs_detail_display.js"></script>
<style type="text/css">
			...
			<div style="padding: 10px">
				<div id="frame" class="loadframe"
					...
					<div id="div_tab1" class="div_tab divtab_menu">
						<ul style="width:100%">
							<li  class="selected" style="width:15%">NCS记录查询</li>
							<li style="width:14%">NCS记录详情</li>
						</ul>
					</div>
					...
					<div class="divtab_content">
						...
						<div id="div_tab1_1" style="display: none;">
							<div id="ncs_detail_tab" class="div_tab divtab_menu">
								<ul>
									<li>小区测量信息</li>
									<li>邻区测量信息</li>
									<%--
							...
							<div style="overflow:auto; ">
								<div id="ncs_detail_tab_0" class="ncsDetailDivCls" data="cell"><%@ include
										file="rno_structure_cell_data.jsp"%>
								</div>
								<div id="ncs_detail_tab_1" class="ncsDetailDivCls" data="ncell"
									style="display:none"><%@ include
										file="rno_structure_ncell_data.jsp"%></div>
								<div id="ncs_detail_tab_2" class="ncsDetailDivCls"
									data="cluster" style="display:none">
									<div style="float: left;width: 50%"><%@ include
										file="rno_structure_cluster_data.jsp"%></div>
									<div style="float:left;width: 47%;margin-left: 6px">
									<table id="clusterresTab" width="100%" border="1px" cellpadding="0" cellspacing="0" style="font-size:12px;" class="greystyle-standard">
										  <tr>
										    <td colspan="3" align="left">簇内小区：</td>
										  </tr>
										  <tr align="center">
										    <td>小区</td>
										    <td>邻区</td>
								...
								<div id="ncs_detail_tab_3" class="ncsDetailDivCls"
									data="intermatrix" style="display:none"><%@ include
										file="rno_structure_interfer_matrix.jsp"%></div>
							</div>
						</div>
					</div>
				</div>
