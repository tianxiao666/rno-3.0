...
<script type="text/javascript" src="js/rno_res_2g_eri_mrr.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > MRR数据管理 > 爱立信MRR数据管理</h2></span>
	<div class="loading_cover" id="loadingDataDiv" style="display: none">
		<div class="cover"></div>
		<h4 class="loading">
			正在加载 <em class="loading_fb" id="loadContentId"></em>,请稍侯...
		</h4>
	</div>
			...
			<div id="listinfoDiv">
				 	<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="ERICSSONMRRFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMrr" enctype="multipart/form-data"
								method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="ERICSSONMRRFILE" /> <input type="hidden" name="token"
								id="token" value="" />
									...
									<tbody>
										<tr>
											...
											<td><s:set name="todaytime" value="new java.util.Date()" />
												<input name="meaTime" class="" id='meatime'
												value="<s:date name="todaytime" format="yyyy-MM-dd" />"
					...
					<div id="importListDiv" class="sectionDivCls">
						...
						<div class="paging_div" id="mrrImportRecPageDiv"
							style="border: 1px solid #ddd">
							<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
								条记录
							</span> <a class="paging_link page-first" title="首页"
								onclick="showListViewByPage('first',queryImportDataRec,'searchImportForm','mrrImportRecPageDiv')"></a>
							<a class="paging_link page-prev" title="上一页"
								onclick="showListViewByPage('back',queryImportDataRec,'searchImportForm','mrrImportRecPageDiv')"></a>
							...
							<a class="paging_link page-go" title="GO"
								onclick="showListViewByPage('num',queryImportDataRec,'searchImportForm','mrrImportRecPageDiv')">GO</a>
							<a class="paging_link page-next" title="下一页"
								onclick="showListViewByPage('next',queryImportDataRec,'searchImportForm','mrrImportRecPageDiv')"></a>
							<a class="paging_link page-last" title="末页"
								onclick="showListViewByPage('last',queryImportDataRec,'searchImportForm','mrrImportRecPageDiv')"></a>
						</div>
					</div>
			</div>
			<%--某项job的报告 --%>
		...
		<div id="tabs-2">
			<div id="mrrDescListDiv">
				<form id="searchMrrForm">
					...
					<table>
						<tr>
							...
							<td><input type="text" value="" id="mrrMeaBegDate"
								name="attachParams['mrrMeaBegDate']" style="width:135px" /></td>
							<td>至：</td>
							<td><input type="text"
								value="<s:date name="todaytime" format="yyyy-MM-dd" />"
								id="mrrMeaEndDate" name="attachParams['mrrMeaEndDate']"
				...
				<div id="mrrListDiv" class="sectionDivCls">
					...
					<div class="paging_div" id="mrrListPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryMrrDescData,'searchMrrForm','mrrListPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryMrrDescData,'searchMrrForm','mrrListPageDiv')"></a>
						第 <input type="text" id="showCurrentPage" class="paging_input_text"
							value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
							class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryMrrDescData,'searchMrrForm','mrrListPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryMrrDescData,'searchMrrForm','mrrListPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryMrrDescData,'searchMrrForm','mrrListPageDiv')"></a>
					</div>
				</div>
			</div>
			<%-- 查看mrr文件详情--%>
			<div id="mrrDetailDiv" style="display:none">
				<div style="width: 94%;margin-top: 20px; margin-left: 1%;">
					<ul id="icons" class="ui-widget ui-helper-clearfix"
						style="width:100px;cursor:pointer">
						<li class="ui-state-default ui-corner-all" title="返回列表"
							style="width:100px" onclick="javascript:returnToMrrList();"> << 返回列表</li>
					</ul>
					<form id="searchMrrDetailForm">
						...
						<input type="hidden" id="hiddenTotalCnt" value="-1" name="page.totalCnt" />
						<input type="hidden" id="hiddenMrrDescId" value="" name="attachParams['mrrDescId']" />
					</form>
					<table id="mrrDetailListTab" class="greystyle-standard"
						style="width:auto;margin-left:0">
						<thead>
							<th>小区名</th>
							<th>BSC</th>
					...
					<div class="paging_div" id="mrrDetailListPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryMrrDetailData,'searchMrrDetailForm','mrrDetailListPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryMrrDetailData,'searchMrrDetailForm','mrrDetailListPageDiv')"></a>
						第 <input type="text" id="showCurrentPage" class="paging_input_text"
							value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
							class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryMrrDetailData,'searchMrrDetailForm','mrrDetailListPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryMrrDetailData,'searchMrrDetailForm','mrrDetailListPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryMrrDetailData,'searchMrrDetailForm','mrrDetailListPageDiv')"></a>
					</div>	
			    </div>
			</div>
		</div>
