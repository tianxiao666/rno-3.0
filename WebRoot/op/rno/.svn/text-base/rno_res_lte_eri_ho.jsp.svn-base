...
<script type="text/javascript" src="js/rno_res_lte_eri_ho.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > 爱立信切换数据管理 </h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">爱立信切换数据导入</a></li>
			<li><a href="#tabs-2">爱立信切换数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					...
					<div id="importDiv" class="importContent">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_ERI_HO_FILE" /> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">LTE爱立信切换数据文件<span class="txt-impt">*</span>
											</td>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				...
				<div class="paging_div" id="ncsListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryEriHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryEriHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryEriHoDescData,'searchNcsForm','ncsListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryEriHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryEriHoDescData,'searchNcsForm','ncsListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
