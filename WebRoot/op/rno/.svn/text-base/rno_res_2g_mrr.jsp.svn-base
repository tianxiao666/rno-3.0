...
<script type="text/javascript" src="js/rno_res_2g_mrr.js"></script>
<script
...
<body>
	<span class='navTitle'><h2>当前位置：数据配置管理 > GSM测量数据管理 > MRR数据管理 </h2></span>
			...
			<div id="listinfoDiv">
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMrr" enctype="multipart/form-data"
							...
							<input type="hidden" id="isToHbase" name="isToHbase" value=""/>
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<select id="factory"
										name="">
											<option value='ERICSSONMRRFILE'>爱立信</option>
											<option value='2GHWMRRFILE'>华为</option>
											</select>
												</td>
										</tr>
									</tbody>
			...
			<div id="mrrListDiv" class="sectionDivCls">
				<table id="mrrListTab" class="greystyle-standard"
					...
					<thead>
						...
						<th id="ttime">测量时间</th>
						<th id="tbsc">BSC</th>
						<th id="tcount">小区数据量</th>
						<TH id="tenter">进入系统时间</TH>
						<TH id="tspeed">速率类型</TH>
					</thead>
				</table>
