...
<script type="text/javascript" src="js/rno_res_lte_sf.js"></script>
<script
...
<body>
	<div style="margin: 20px;">
		<span class='navTitle'><h2>当前位置：数据配置管理 > LTE测量数据管理 > 扫频数据管理</h2></span>
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">扫频数据导入</a></li>
				<li><a href="#tabs-2">扫频数据查询 </a></li>
			</ul>
			<div id="tabs-1">
				<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv"
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_SF_FILE" /> <input type="hidden" id="hiddenPageSize"
							...
							<table>
								<tr>
									...
									<td><select id="importstatusmenu" name="attachParams['fileStatus']">
					...
					<div id="importDiv" class="importContent">
						<form id="formImport" enctype="multipart/form-data" method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_SF_FILE" /> <input type="hidden" name="token"
								id="token" value="" /> <input type="hidden" id="uploadCityId"
								name="cityId" value="" />
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">LTE扫频数据文件<span class="txt-impt">*</span>
											</td>
					...
					<table>
						<tr>
							...
							<td style="padding-left:10px"><input type="button"
								id="searchDescBtn" value="查询"></input></td>
						</tr>
					</table>
				</form>
				<div class="sectionDivCls">
					<table id="descListTab" class="greystyle-standard"
						style="width:auto;margin-left:0">
						<thead>
							<th>地市</th>
							<th>文件</th>
					...
					<div class="paging_div" id="listPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryDescData,'searchDescForm','listPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryDescData,'searchDescForm','listPageDiv')"></a>
						第 <input type="text" id="showCurrentPage"
							class="paging_input_text" value="0" /> 页/<em id="emTotalPageCnt">0</em>页
						<a class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryDescData,'searchDescForm','listPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryDescData,'searchDescForm','listPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryDescData,'searchDescForm','listPageDiv')"></a>
					</div>
				</div>
			</div>
		</div>
