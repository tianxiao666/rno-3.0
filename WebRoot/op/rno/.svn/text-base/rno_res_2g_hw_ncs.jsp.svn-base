...
<script type="text/javascript" src="js/rno_res_2g_hw_ncs.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > NCS数据管理 > 华为NCS数据管理</h2></span>
			...
			<div id="listinfoDiv">
					...
					<div id="importDiv" class="importContent">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="HUAWEINCSFILE" /> <input type="hidden" name="token"
								id="token" value="" />
