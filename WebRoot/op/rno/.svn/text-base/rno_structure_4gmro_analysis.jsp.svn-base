...
<html>
  ...
  <body>
	...
	<font style="font-weight: bold;">当前位置： 结构优化 > LTE结构优化分析</font>
	<br>
	<div id="structureTaskDiv">
			...
			<div style="width: 80%;margin-left: 6%;padding-top: 10px">
				...
				<form id='downloadStructureFileForm' action='downloadLteStructureFileAction' method='post' style="display:none">
