...
<script type="text/javascript"
	src="js/rno_structure_mrr_orifile_import.js"></script>
<style type="text/css">
								...
								<table class="main-table1 half-width">
									<tbody>
										...
										<tr>
										  ...
										  <td>
										 	 爱立信&nbsp;&nbsp;<input type="radio" class="fileCodeCls" id="eric" name="fileCode" value="ERICSSONMRRFILE" checked="checked" />
