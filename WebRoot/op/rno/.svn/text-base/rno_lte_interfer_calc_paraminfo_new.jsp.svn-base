...
<body>
	...
	<center>
		...
		<font style="font-weight: bold;">任务信息>><font	style="color: #31FF81;">参数配置</font>>>流量文件>>扫频数据>>提交任务</font><br>
	</center>
	...
	<div style="text-align:center">
		<div style="width: 700px;margin: 20px auto;">
			<table style="width:500px;margin: 5px auto;">
				<tr>
					<td style="text-align:center"><input type="button"
						id="paramInfoPreStep" name="" value="<上一步 " /></td>
					<td style="text-align:center"><input type="button"
						id="paramInfoNextStep" name="" value="下一步 >" /></td>
				</tr>
			</table>
			...
			<table id="structureParamTable" class="paramTable">
				...
				<s:iterator value="#session.MRTASKINFO.groupThresholds"
					id="groupThreshold">
					<tr>
						<td><s:iterator value="value" id="threshold" status="u">
								<s:if test="!#u.last">
						...
						<td style="width: 30%"><s:iterator value="value"
								id="threshold" status="u">
								<s:if test="!#u.last">
									<div id="<s:property value="#threshold.code" />"
										class="editbox" style="height: 23px;">
										<s:property value="#threshold.defaultVal" />
									</div>
									<span id="<s:property value="#threshold.code" />"
										class="errorTip"></span>
									<br />
								</s:if>
								<s:else>
...
<script type="text/javascript">
	...
	$("#SAMEFREQCELLCOEFWEIGHT").text(
			Number($("#SAMEFREQCELLCOEFWEIGHT").text()).toFixed(2));
	$("#SWITCHRATIOWEIGHT").text(
			Number($("#SWITCHRATIOWEIGHT").text()).toFixed(2));
</script>
</html>
