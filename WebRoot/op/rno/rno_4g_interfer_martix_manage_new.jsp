...
<script type="text/javascript"
	src="js/rno_lte_interfer_martix_manage_new.js?v=<%=(String) session.getAttribute("version")%>"></script>

</head>
<input type="hidden" id="cityIdFromRes"
	...
	<div id="taskProfileDiv">
			...
			<form id="interferMartixForm" method="post">
				...
				<table class="main-table1 half-width" style="padding-top: 10px;">
					<tr>
						...
						</select> 市：<select name="cond['cityId']" class="required" id="cityId2">
						...
						<td style="text-align: left">干扰矩阵创建时间： <s:set name="begtime"
		...
		<div style="width: 80%;margin-left: 6%;padding-top: 10px">
			...
			<form id='download4GMatrixFileForm'
				action='downloadNewLteInterMatrixFileAction' method='post'
				style="display:none">
