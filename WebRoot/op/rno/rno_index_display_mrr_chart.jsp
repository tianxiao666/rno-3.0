...
<script src="js/rno_index_display_mrr_chart.js"></script>
						...
						<div class="divtab_content" style="overflow-y:auto; overflow-x:auto; width:100%; height:600px;">
							...
							<%-- 分隔栏--%>
								...
								<div class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title">开始日期</span>&nbsp;&nbsp;&nbsp;<input type="text" value="" id="mrrMeaBegDate"
								...
								<div class="div-m-split-10px"></div>
								<div class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title">CHGR</span>&nbsp;&nbsp;&nbsp;<select
																	id='mrrChgr'
																	style="width:100px;margin-left:22px;margin-right:8px">
																	<option>ALL</option>
																	<option>0</option>
																	<option>1</option>
																	<option>2</option>
								...
								<div class="div-m-split-10px"></div>
								<div class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title">图表类型</span>&nbsp;&nbsp;&nbsp;<select
																	id='mrrChartType'
																	style="width:100px;margin-left:8px;margin-right:8px">
																	<option value="singleVal">单个值图形</option>
