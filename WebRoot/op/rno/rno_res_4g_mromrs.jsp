...
<script type="text/javascript" src="js/rno_res_4g_mromrs.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：数据配置管理 > LTE测量数据管理 > 结构优化MR导入</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">MROMRS数据导入</a></li>
			<li><a href="#tabs-2">MROMRS数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4MROMRSFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMr" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4MROMRSFILE" /> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">MROMRS测量文件<span class="txt-impt">*</span>
											</td>
											<td style="width: 50%; font-weight: bold" colspan="0"><input
												type="file" style="width: 44%;" name="file" id='fileid'
												class="canclear required" />
												<span style="color:red;width:100px;font-family:华文中宋;text-align:center" id="fileDiv"/>
											</td>
										</tr>
			...
			<form id="searchMrForm">
				...
				<table>
					<tr>
						...
						<td  style="padding-left:10px"><input type="button" id="searchMrBtn" value="查询MROMRS"></input></td>
					</tr>
				</table>
