...
<script src="js/rno_index_display_ni_chart.js"></script>
						...
						<div class="divtab_content" style="overflow-y:auto; overflow-x:auto; width:100%; height:600px;">
							...
							<%-- 分隔栏--%>
								...
								<div class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title">出图类型</span>&nbsp;&nbsp;&nbsp;<select
																	id='mrrChartType'
																	style="width:100px;margin-left:8px;margin-right:8px">
																	<option value="singleVal">单小区出图</option>
																	<option value="accumulatedVal">多小区出图</option>
																	</select>
								</div>
							<%-- 分隔栏--%>
								<div class="div-m-split-10px"></div>
								<div id="start_date_div"  class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title"><span id="date_text_change">开始日期</span></span>&nbsp;&nbsp;&nbsp;<input type="text" value="" id="mrrMeaBegDate"
															name="" style="width:100px;margin-left:8px;margin-right:8px" /><input id="addto_date" type="button" value="添加" />
										</div>
										<textarea id="date_msg" name="" cols=40 rows=4 style="width:250px;"></textarea>
								<%-- 分隔栏--%>
								<div id="end_date_seq" class="div-m-split-10px"></div>
								<div id="end_date_div" class="div_title_24px_blue title_width">
									<span class="sp_title analysis_list_title">结束日期</span>&nbsp;&nbsp;&nbsp;<input type="text" value="" id="mrrMeaEndDate"
								...
								<span id="cellselect_span">请在左侧小区树形图中选择小区：</span>
								<textarea id="cell_msg" name="" cols=40 rows=4 style="width:250px;"></textarea>
								<input id="cellsconfirm" type="button" value="获取小区指标" />
							</div>
