...
<script type="text/javascript" src="js/rno_lte_azimuth_assessment.js?v=<%=(String)session.getAttribute("version")%>"></script>
...
.taskInfoTab td
{
  ...
  <body>
	...
	<form id='initMroAnalysisPageForm' action="init4GAzimuthAssessmentPageAction" method='post' style="display:none">
		<input type="hidden" id="cityId" name="cityId" value="<s:property value="cityId" />"/>
	</form>
  	<font style="font-weight: bold;">当前位置： 动态覆盖 &gt; LTE天线方位角评估 &gt; 新建LTE天线方位角评估分析任务</font>
	<br>
	<center>
  	<a href="init4GAzimuthAssessmentPageAction" style="text-decoration: underline;font-weight: bold;"><<返回任务列表</a><br/><br/>
