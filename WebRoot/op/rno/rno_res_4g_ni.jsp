...
<script type="text/javascript" src="js/rno_res_4g_ni.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：数据配置管理 > LTE干扰数据管理 > 干扰优化NI导入</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">NI数据导入</a></li>
			<li><a href="#tabs-2">NI数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4NIFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMr" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4NIFILE" /> <input type="hidden" name="token"
								id="token" value="" />
								...
								<table class="main-table1 half-width"
									...
									<tbody>
											...
											<s:set name="todaytime" value="new java.util.Date()" />
												...
												value="<s:date name="todaytime" format="yyyy-MM-dd" />"
												type="hidden" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
												readonly class="Wdate input-text" style="width: 132px;" />
										<tr>
											<td class="menuTd">NI测量文件<span class="txt-impt">*</span>
											</td>
			...
			<form id="searchNiForm">
				...
				<table>
					<tr>
						...
						<td  style="padding-left:10px"><input type="button" id="searchNiBtn" value="查询NI"></input></td>
					</tr>
				</table>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				...
				<div class="paging_div" id="mrListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryNiDescData,'searchNiForm','mrListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryNiDescData,'searchNiForm','mrListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryNiDescData,'searchNiForm','mrListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryNiDescData,'searchNiForm','mrListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryNiDescData,'searchNiForm','mrListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
