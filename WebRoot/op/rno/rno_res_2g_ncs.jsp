...
<script type="text/javascript" src="js/rno_res_2g_ncs.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：数据配置管理 > GSM测量数据管理 > NCS数据管理 </h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">NCS数据导入</a></li>
			<li><a href="#tabs-2">NCS数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
									...
									<tbody>
										...
										<tr>
										 ...
										 <tr>
											...
											<select id="factory"
										name="">
											<option value='ERICSSONNCSFILE'>爱立信</option>
											<option value='HUAWEINCSFILE'>华为</option>
											</select>
												</td>
										</tr>
									</tbody>
		...
		<div id="tabs-2">
			<form id="searchNcsForm">
				...
				<table>
					<tr>
						...
						<td  style="padding-left:10px"><input type="button" id="searchNcsBtn" value="查询NCS"></input></td>
					</tr>
				</table>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				<table id="ncsListTab" class="greystyle-standard"
					...
					<thead>
						<th id="thcity">地市</th>
						<th id="thtime">测量时间</th>
						<th id="thbsc">BSC</th>
						<th id="thname">频段/测试数据量</th> 
						<th id="thenter">进入系统时间</th>
					</thead>
				</table>
