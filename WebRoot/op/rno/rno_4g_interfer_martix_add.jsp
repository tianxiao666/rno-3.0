...
<script type="text/javascript" src="js/rno_4g_interfer_martix_add.js?v=<%=(String)session.getAttribute("version")%>"></script>
  ...
  <body>
	...
	<font style="font-weight: bold;">当前位置： PCI优化 &gt; 干扰矩阵计算 &gt; 新计算</font>
	<br>
  	<%-- 干扰矩阵查询条件 --%>
    <div style="width: 80%;margin-top: 5px; margin-left: 6%;">
 	   	<div style="margin-bottom: 5px;text-align:center">
 	 	<a href="init4GInterferMartixManageAction" style="text-decoration: underline;font-weight: bold;"><<返回任务列表</a><br/>
 	 	</div>
