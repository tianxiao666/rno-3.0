...
function bindEvent(){
	...
	$("#searchImportBtn").click(function(){
		...
		var factory=$("#formImportHo #factory").find("option:selected").val();
		console.log(factory);
...
function doUpload() {
	...
	var factory=$("#formImportHo #factory").find("option:selected").val();
	$("#formImportHo #fileCode").val(factory);
	$("#progressNum").text('0%');
	$("#progressbar").progressbar({
		value : 0
	});
	...
	fileSize = 1;
	var fileCode = $("#formImportHo #fileCode").val();
	var attachParams = {};
