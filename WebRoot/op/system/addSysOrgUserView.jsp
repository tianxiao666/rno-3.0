...
<script type="text/javascript">
	...
	function providerPassword(){
		...
		//密码提示
		if(password == null || password.replace(/(^\s*)/, "") == ""){
			errorStr = "密码不能为空";
		...
		if(affirmpassword == null || affirmpassword.replace(/(^\s*)/, "") == ""){
...
function checkProviderPhoneNumber(){
	...
	<body>
		...
		<form method="post" action="addOrgUserAndPostAction" id="orgUserForm">
					...
					<div style="width: 600px;">
						<table>
							<tr height="40px;">
								...
								<td  style="width: 200px;"><input class="required input-text" id="account" autocomplete="off" type="text" value="" onblur="checkProviderAccount();" />
							...
							<tr height="40px;">
								<td>
									密码：<span class="redStar" style="float:right; padding-right:8px;">*</span>
								</td>
								<td ><input class="required input-text" style="width: 200px;" type="password" autocomplete="off" id="password" name="sysAccount.password" value="" onblur="checkProviderPassword();"/>
								</td>
								<td>
							...
							<tr height="40px;">
								<td>
									确认密码：<span class="redStar" style="float:right; padding-right:8px;">*</span>
								</td>
								<td ><input class="required input-text" style="width: 200px;" type="password" autocomplete="off" id="affirmpassword" value="" onblur="checkProviderPassword();"/>
								</td>
								<td>
							...
							<tr height="40px;">
								...
								<td ><input class="required input-text" name="sysOrgUser.name" id="name" type="text" value="" onblur="checkProviderName();"/>
								</td>
								<td>
							 ...
							 <tr height="40px;">
								...
								<td><input class="required input-text" name="sysOrgUser.email" type="text" onblur="checkProviderEmail();" id="email" on value=""/>
								</td>
								<td>
							...
							<tr height="40px;">
								...
								<td><input type="radio" name="sysOrgUser.gender" checked="checked" value="male"/>男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sysOrgUser.gender" value="female"/>女
								</td>
							</tr>
							<tr height="40px;">
								<td>
								...
								<td ><input class="required input-text"  name="sysOrgUser.mobile" id="phoneNumber"  type="text" value="" onblur="checkProviderPhoneNumber();"/>
								</td>
								<td>
							...
							<tr height="40px;">
								...
								<td ><input type="checkbox" checked="checked"  name="sysOrgUser.status"  value="1"/>有效
						...
						<div class="endow_role_info">
								<div class="role_table">
									...
									<input value="保存" type="button" onclick="addOrgUserAndPost();"/>
									</div>
					</div>
					</div>
				</div>
