...
<script type="text/javascript" src="js/reportOrgCompareCount.js"></script>
...
<div id="statements_content">
	...
	<div class="statements_right">
	    <div class="statements_menu_title clearfix">
		    <p class="fl">人员及任务数综合统计</p>
		    <input type="hidden" id="orgNameText" value="人员及任务数综合统计"/>
			<p class="fr">
		...
		<div class="statements_select" style="top: 124px;z-index:15;margin-right:30px;">
			...
			<div id="compareTab_0" class="statements_img_half">
				<div class="statements_tab">
					...
					<div class="statements_img">
						...
						<div id="orgReportDiv"  style="height: 280px;"></div>
					</div>
				</div>
			</div>
			<br />
