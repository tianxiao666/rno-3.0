...
<script type="text/javascript" src="js/reportOrgWorkOrderCount.js"></script>
...
<div id="statements_content">
	...
	<div class="statements_right">
	    <div class="statements_menu_title clearfix">
		    <p class="fl">人员任务量统计</p>
		    <input type="hidden" id="orgNameText" value="人员任务量统计"/>
			<p class="fr">
		...
		<div class="tab_menu">
			<ul>
				...
				<li onclick="getOrgProjectReportInfo()" id="projectLi">按项目</li>
			</ul>
		</div>
		<div class="statements_select" style="top:99px;z-index:15;margin-right:30px;">
			<span onclick="clickReturnReport();" style="display:none;" title="返回上级" id="statements_back" class="statements_back"></span>
		</div>
		<div class="compare_info" style="margin-top: 15px;">
			<div id="compareTab_0" class="statements_img" >
				<em onclick="addDivChar();" class="st_full_screen"></em>
				<div id="orgWorkOrderCountDiv"  style="height: 280px;"></div>
			</div>
			<br />
			<%--报表详情--%>
			...
			<div class="statements_comment">
				<%--评论位置--%>
				<div class="statements_comment" id="reportComment" name="reportComment"></div>
			</div>
		</div>
	</div>
	<%--右边报表结束--%>
