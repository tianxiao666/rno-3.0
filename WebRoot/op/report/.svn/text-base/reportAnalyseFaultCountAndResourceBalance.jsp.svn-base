...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/reportAnalyseFaultCountAndResourceBalance.js"></script>
						...
						<div class="statements_tab">
								...
								<div class="tab_content">
									...
									<%-- <div>
										<div class="statements_table_top">
											<span><a class=""><em>[-]</em>展开表格</a></span>
											<span>工单总数：<em id="uCount">0</em></span>
											<span>人员总数：<em id="upCount">0</em></span>
											<span>车辆总数：<em id="uProcessTime">0</em></span>
										</div>
										<div class="statements_main_table" style="display: block;">
											<table class="main_table tc">
												<tbody>
													<tr>
														<th style="width: 55px;">按故障类型</th>
														<th>工单数</th>
														<th>工单处理历时(小时)</th>
														<th>故障处理及时率</th>
													</tr>
							...
							<div class="clearfix">
								<div class="statements_img">
									...
									<div id="resultReport" style="height:250px;"></div>
								</div>
							</div>
