...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<script type="text/javascript" src="jslib/organizationByOrgIdPage.js"></script>
		...
		<script type="text/javascript">
			$(function() {
				var de = $("#hidden_orgId").val();
				showProviderOrgBaseInfo(de);
				showProviderAccountInfo(de);
				//组织添加/修改基本信息弹出框
  	...
  	<body>
  		<input type="hidden" id="hidden_orgId" value="${param.orgId }" />
					...
					<div class="architecture_right" id="providerOrgDiv" style="display:none;">
						...
						<div id="service_tab" class="tab_menu">
							<ul>
								...
								<li style="display:none;" >维护网络资源</li>
							</ul>
						</div>
						<%--tab title结束--%>
						...
						<div class="container_info">
							...
							<div id="service_tab_1" style="display:none;">
								<div class="container_info_pe_top clearfix">
									<div class="pe_left"  style="display:none;">
							...
							<%-- 
							 ...
							 --%>
								<div class="network_top" id="p_network_top" style="display: n">
								...
								<tbody>
									...
									<td class="menu_td">区域选择：</td><%-- yuan.yw --%>
										<td colspan="3" style="width:240px">
											...
											<div id="org_c_area_server_treeDiv" class="areaservice_tree">
					...
					<div class="dialog_content">
						...
						<div class="staff_content">
							<div id="staff_tab_0">
								...
								<div class="dialog_but staff_account_but"  style="display:none;">
							...
							<div id="staff_tab_1" style="display:none;">
								...
								<div class="dialog_but staff_other_but" style="display:none;">
							...
							<div id="staff_tab_2" style="display:none;">
								...
								<div class="dialog_but staff_skill_but" style="display:none;">
									<button class="aui_state_highlight staffInfo_modify authorityControlClass">修改</button>
