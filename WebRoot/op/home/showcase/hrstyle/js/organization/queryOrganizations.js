...
function showStation(currentPage) {
	...
	$.ajax( {
		...
		var tr = "";
		$.each(organizations, function(key, object) {
			tr = tr + "<tr>";
			tr = tr + "<td  style='text-align: left'>" + object.orgCode
					+ "</td>";
			tr = tr + "<td  style='text-align: left'>" + object.orgName
					+ "</td>";
			tr = tr + "<td   style='text-align: left'>" + object.orgChargeMan
					+ "</td>";
			tr = tr + "<td   style='text-align: left'>" + object.orgStatus
					+ "</td>";
			tr = tr + "<td style='text-align: left'  class='tdr'>"
					+ "<a href='organizationDetail.html?id="
					+ object.substanceId + "'>详细</a>" + "</td>";
			tr = tr + "</tr>";
		...
		tr = tr
				+ foots("queryOrganizationAction", page.currentPage,
						page.totalPage, page.prePage, page.nextPage,
						page.pageSize);
