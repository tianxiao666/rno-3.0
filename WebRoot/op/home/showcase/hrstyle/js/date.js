...
function getDateDiv() {
	...
	dateDiv += "<div id='calendardiv' onclick='event.cancelBubble=true' "
			...
			+ " style='"
			+ noSelectForFireFox
			+ "position:absolute;z-index:99;visibility:hidden;border:1px solid #8bb8f3;'>";
	dateDiv += "<table border='0' bgcolor='#c3daf9' width='190px'cellpadding='1' cellspacing='1' >";
	dateDiv += "<tr>";
	...
	dateDiv += "</td><td><select id='tbSelYear' style='border:1px solid;height:19px' onchange='fUpdateCal(getFirstObj_(\"tbSelYear\"),getFirstObj_(\"tbSelMonth\"))'>";
	for (var i = startYear; i < endYear; i++) {
		dateDiv += "<option value='" + i + "'>" + i + strYear + "</option>";
	}
	dateDiv += "</select></td><td>";
	dateDiv += "<select id='tbSelMonth' style='border:1px solid;height:19px' onchange='fUpdateCal(getFirstObj_(\"tbSelYear\"),getFirstObj_(\"tbSelMonth\"))'>";
	for (var i = 0; i < 12; i++) {
...
var str="";
	...
	str += "<select id='tbSelHour' style='border:1px solid;height:19px' onchange='fSetTime(getFirstObj_(\"tbSelHour\"),getFirstObj_(\"tbSelMinute\"),getFirstObj_(\"tbSelSecond\"))'>";
	for (var i = 0; i < 24; i++) {
	...
	str += "<select id='tbSelMinute' style='border:1px solid;height:19px' onchange='fSetTime(getFirstObj_(\"tbSelHour\"),getFirstObj_(\"tbSelMinute\"),getFirstObj_(\"tbSelSecond\"))'>";
	for (var i = 0; i < 60; i++) {
		str += "<option value='" + i + "'>"	+i+ "</option>";
	}
	str += "</select>";
	...
	str += "<select id='tbSelSecond' style='border:1px solid;height:19px' onchange='fSetTime(getFirstObj_(\"tbSelHour\"),getFirstObj_(\"tbSelMinute\"),getFirstObj_(\"tbSelSecond\"))'>";
	for (var i = 0; i < 60; i++) {
		str += "<option value='" + i + "'>"	+i+ "</option>";
	}
	str += "</select>";
