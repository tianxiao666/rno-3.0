...
function tigra_tables (
	...
	col_config.even_color = (str_even_color ? str_even_color : '#f3f9fc');
	col_config.mover_color = (str_mover_color ? str_mover_color : '#fcf4ee');
	col_config.onclick_color = (str_onclick_color ? str_onclick_color : '#fcf4ee');
