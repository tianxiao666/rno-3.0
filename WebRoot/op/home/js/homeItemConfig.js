 ...
 var item_editor = new Ext.ux.grid.RowEditor({
        ...
        listeners: { 
	        ...
	        afteredit:function (r, o, record,n){
				...
				//AJAX保存
				Ext.Ajax.request({
				   url: 'op/home/saveHomeItemAction.action',
...
// Store定义
var item_dataUrl = 'op/home/getAllHomeItemListAction.action';
var item_store = new Ext.data.JsonStore({
	    url: item_dataUrl,
	    root: 'result',
	    fields: ['id', 'title', 'showTitle','url','maxUrl','defaultHeight','defaultWidth']
        ...
        },
    	{
            ...
            handler : function(){
                ...
                if(confirm("确定要删除选定的组件吗？")){
					...
					//AJAX删除
					Ext.Ajax.request({
					   url: 'op/home/deleteHomeItemAction.action',
					   params: { id:id},
					   success: function(){
