...
public class ConversationHelper {
	...
	public static <T> T requestMap2Object ( Map map , Class clazz , String objKey ) throws Exception {
		return ObjectUtil.requestMap2Object(map, clazz, objKey);
	}
	...
	public static <T> T map2Object ( Map map , String className ) throws Exception {
		return ObjectUtil.map2Object( map, className );
	}
	...
	public static <T> T map2Object ( Map map , Class clazz ) throws Exception {
		return ObjectUtil.map2Object( map, clazz );
	}
	 ...
	 * @return 数据集合
	 */
	public static <T> Map<String,Object> object2Map( T obj , boolean isIncludeSuper ) throws Exception {
		return ObjectUtil.object2Map(obj, isIncludeSuper);
	}
	 ...
	 * @return 数据集合
	 */
	public static <T> Map<String,String> object2MapString( T obj , boolean isIncludeSuper ) throws Exception {
		return ObjectUtil.object2MapString(obj, isIncludeSuper);
	}
	...
	private static class ObjectUtil {
		 ...
		 * @return 属性数组
		 */
		private static String[] getClassFieldArray ( Class clazz ) {
		...
		private static <T> void setValue  ( T instance , String key , Object value ) throws Exception {
			Method method = null;
		...
		private static <T> void createFieldObject ( T instance , String keys ,Object value  ) {
			try {
				if ( keys.isEmpty() ) {
					return;
				}
		 ...
		 * @return 方法map<方法名,方法对象>集合
		 */
		private static Map<String,Method> getClassMethods ( Class clazz , String topString ) {
		 ...
		 * @return 父类集合
		 */
		private static List<Class> getSuperClassList ( Class clazz ) {
			Class spClazz = null;
			try {
		 ...
		 * @return 该类的所有属性
		 */
		private static List<Field> getClassFieldList ( Class clazz , boolean isIncludeSuper ) {
		 ...
		 * @return setter方法名
		 */
		private static String getSetterMethodNameString (String propertyString ) {
		 ...
		 * @return getter方法名
		 */
		private static String getGetterMethodNameString (String propertyString ) {
			String head = propertyString.substring(0,1);
			head = head.toUpperCase();
			String foot = propertyString.substring(1);
