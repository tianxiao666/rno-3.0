...
import com.iscreate.op.pojo.project.ProSubInfo;
import com.iscreate.op.pojo.system.SysUserRelaOrg;

public class SysUserRelaOrgServiceImpl implements SysUserRelaOrgService {
	...
	public List<Map<String,Object>> getAllTopUserByOrgUserId(long org_user_id){
		return this.sysUserRelaOrgDao.getAllTopUserByOrgUserId(org_user_id);
	}
	/**
	 * @author:duhw
	...
	public List<Map<String,Object>> getAllTreeOrgByOrgUserId(long org_user_id){
		return this.sysUserRelaOrgDao.getAllTreeOrgByOrgUserId(org_user_id);
	}
	...
	* @throws
	...
	public int saveSysUserRelaOrg(SysUserRelaOrg sysUserRelaOrg){
		Map<String, Object> infoMap = installedProSysUserRelaOrg(sysUserRelaOrg);
		return this.sysUserRelaOrgDao.saveSysUserRelaOrg(infoMap);
	}
	
	
	
	public Map<String, Object> installedProSysUserRelaOrg(SysUserRelaOrg sysUserRelaOrg){
		if(sysUserRelaOrg != null){
			Map<String, Object> infoMap = new HashMap<String, Object>();
			infoMap.put("ORG_USER_ID", sysUserRelaOrg.getOrgUserId());
			infoMap.put("ORG_ID", sysUserRelaOrg.getOrgId());
			infoMap.put("STATUS", sysUserRelaOrg.getStatus());
			return infoMap;
		}else{
			return null;
		}
	...
	public List<SysUserRelaOrg> getSysUserRelaOrgListByOrgUserIdsAndOrgId(long orgId,String orgUserIds){
		return this.sysUserRelaOrgDao.getSysUserRelaOrgListByOrgUserIdsAndOrgId(orgId, orgUserIds);
	}
	/**
	 * 
	...
	public List<Map<String,Object>> getAllTreeOrgByAccount(String account){
		return this.sysUserRelaOrgDao.getAllTreeOrgByAccount(account);
	}
	...
	* @throws
	...
	public int updateSysUserRelaOrgStatus(String status,long orgUserId){
		return this.sysUserRelaOrgDao.updateSysUserRelaOrgStatus(status, orgUserId);
	}
}
